...
#Add-LocalAdmin
function Add_LocalAdmin ($strComputer){ 
...
$ItemUser = GetInputUser -LabelMessage "Input a User to Add to Local Admins:" -MultiLine $false
...
foreach ($Item in $ItemList)
{
    ...
    {
        Add_LocalAdmin -strComputer $Item 
    }
    Else
    {
