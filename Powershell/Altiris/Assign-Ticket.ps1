...
$ie.Navigate("http://support/AeXHDSD/default.aspx?cmd=invokeTask&id=50&item=$Ticket&v=2")
$ie.Visible = $true
}
...
$ItemList = GetInput -LabelMessage "Input of Ticket Numbers to assign to you!" -MultiLine $true
$ItemList = $ItemList.Split()

foreach ($Item in $ItemList){
    If($Item){
        Get_Ticket -ticket $Item
        }
    }
